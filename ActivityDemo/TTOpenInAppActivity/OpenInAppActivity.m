...
@interface OpenInAppActivity () <UIActionSheetDelegate>
...
@implementation OpenInAppActivity
...
{
    NSBundle *bundle;
    NSURL *openInAppActivityBundleURL = [[NSBundle mainBundle] URLForResource:@"OpenInAppActivity" withExtension:@"bundle"];
...
{
    return NSLocalizedStringFromTableInBundle(@"分享", @"OpenInAppActivityLocalizable", [OpenInAppActivity bundle], nil);
}

- (UIImage *)activityImage
{
    if([[[UIDevice currentDevice] systemVersion] floatValue] >= 8.0){
        return [UIImage imageNamed:@"OpenInAppActivity8"];
    } else if([[[UIDevice currentDevice] systemVersion] floatValue] >= 7.0){
        return [UIImage imageNamed:@"OpenInAppActivity7"];
    } else {
        return [UIImage imageNamed:@"OpenInAppActivity"];
    }
}
...
- (void)openDocumentInteractionControllerWithFileURL:(NSURL *)fileURL
{
    ...
    if(!sucess){
        ...
        NSString *message = [NSString stringWithFormat:NSLocalizedStringFromTableInBundle(@"Your %@ doesn't seem to have any other Apps installed that can open this document.", @"OpenInAppActivityLocalizable", [OpenInAppActivity bundle], nil), deviceType];

        // Display alert
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:NSLocalizedStringFromTableInBundle(@"No suitable App installed", @"OpenInAppActivityLocalizable", [OpenInAppActivity bundle], nil)
                                                        message:message
                                                       delegate:nil
                                              cancelButtonTitle:NSLocalizedStringFromTableInBundle(@"OK", @"OpenInAppActivityLocalizable", [OpenInAppActivity bundle], nil)
...
- (void)openSelectFileActionSheet
{
    UIActionSheet *actionSheet = [[UIActionSheet alloc] initWithTitle:NSLocalizedStringFromTableInBundle(@"Select a file", @"OpenInAppActivityLocalizable", [OpenInAppActivity bundle], nil)
                                                             delegate:self
    ...
    actionSheet.cancelButtonIndex = [actionSheet addButtonWithTitle:NSLocalizedStringFromTableInBundle(@"Cancel", @"OpenInAppActivityLocalizable", [OpenInAppActivity bundle], nil)];
